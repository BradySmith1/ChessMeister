...
public class BoardMonoCLI implements BoardStrategy {
    ...
    public void draw(BoardIF board, GameColor color) {
        ...
        if(color == GameColor.WHITE){
            printWhite(board, squares);
        }else{
            printBlack(board, squares);
        }
    }
     ...
     * @param board the BoardIF object representing the game board to be drawn.
     * @param squares  the SquareIF object representing the game board to be drawn.
     */
    private void printWhite(BoardIF board, SquareIF[][] squares) {
        boolean first;
        System.out.println("   --------------------------------" +
                "-----------------------------------------");
        // Print the board.
     ...
     * @param squares  the SquareIF object representing the game board to be drawn.
     */
    private void printBlack(BoardIF board, SquareIF[][] squares) {
        boolean first;
        System.out.println("   --------------------------------" +
                "-----------------------------------------");
        // Print the board.
